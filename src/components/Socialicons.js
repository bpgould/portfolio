...
function Socialicons(props){
  ...
  return (
    <ul className={props.bordered ? 'mi-socialicons mi-socialicons-bordered' : 'mi-socialicons'}>
      ...
      {!socialLinks.quora ? null : <li>
        <a rel="noopener noreferrer" target="_blank" href={socialLinks.quora}>
          <LineIcon name="quora"/>
        </a>
      </li>}
      {!socialLinks.hackerrank ? null : <li>
        <a rel="noopener noreferrer" target="_blank" href={socialLinks.hackerrank}>
          <LineIcon name="code"/>
        </a>
      </li>}
    </ul>
